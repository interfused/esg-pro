...
if( ! class_exists( 'Frontend_WP_Gutenberg' ) ) :
	...
	public function register_blocks() {
		...
		foreach( $block_assets as $asset ){
			$asset_file = require_once( __DIR__ . "/assets/js/$asset.asset.php");
			wp_register_script( "fea-$asset", FEA_URL . "main/gutenberg/assets/js/$asset.js", $asset_file['dependencies'], $asset_file['version'] );
		}
	
		register_block_type('acf-frontend/form', [
			'editor_script' => 'fea-admin-form',
